                ...
                <div class="card border-0 rounded shadow">
                    <div class="card-body">
                        ...
                        <div class="price-product" id="price-product" style="font-size: 1.35rem"><span
                                class="font-weight-bold mr-4" style="color: green">Rp. {{ calculateDiscount(product)
                                }}</span>
                        ...
                        <button @click.prevent="addCart(product.id, calculateDiscount(product), product.weight)"
